...
if menu == "🏠 Beranda":
    ...
    """)
    st.markdown("📌 Silakan pilih menu di sidebar kiri untuk mulai menggunakan aplikasi.")
...
- Mendukung analisis kualitatif di bidang kimia, farmasi, lingkungan  
""", unsafe_allow_html=True)
...
2. Perhatikan puncak-puncak utama dan nilai bilangan gelombangnya (cm⁻¹).  
...
""")
    ...
    nilai1 = st.number_input("Bilangan gelombang IR pertama (cm⁻¹)", min_value=650, max_value=3700, step=1)
    nilai2 = st.number_input("Bilangan gelombang IR kedua (opsional)", min_value=0, max_value=3700, step=1)

    gugus_fungsi = [
        {"rentang": (3700, 3584), "gugus": "O–H bebas - alkohol"},
        ...
        {"rentang": (1870, 1800), "gugus": "C=O - anhidrida"},
        {"rentang": (1750, 1735), "gugus": "C=O - ester - asam"},
        {"rentang": (1740, 1720), "gugus": "C=O - aldehid - keton"},
        {"rentang": (1720, 1680), "gugus": "C=O - umum"},
        ...
        {"rentang": (1300, 1000), "gugus": "C–O stretching - alkohol/ester"},
...
# Halaman Pembuat Aplikasi
    ...
    st.markdown("""
Aplikasi ini dibuat oleh mahasiswa Program Studi Analis Kimia:

| Nama Lengkap                           | NIM       |
|----------------------------------------|-----------|
| Annisa Balqis Salsabila                | 2460329   |
| Fachria Ilmi Dwikanya Atikasari        | 2460364   |
| Marsya Putri Naisyila                  | 2460414   |
| Nasywa Arta Fatehah                    | 2460460   |
| Silmi Kaffah                           | 2460518   |

📍 Institusi: Politeknik AKA Bogor  
🎯 Tujuan: Membantu pengguna dalam mengidentifikasi gugus fungsi menggunakan Python dan Streamlit sebagai alat bantu belajar kimia organik.
""", unsafe_allow_html=True)
